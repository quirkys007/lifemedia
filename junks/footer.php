                            ...
                            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                                <div class="single-footer-caption mb-50">
                                    ...
                                    <div class="footer-logo">
                                        <a href="home.php"><img src="assets\img\logo-life-media-dan-sims-1024x213-copy.png "
                                                width=" 150" height="50" alt=""></a>
                                    </div>
                                    <div class="footer-tittle">
                                        <div class="footer-pera">
                                            <p class="info1">Jl. Parangtritis 97, RT 57 RW 15, Brontokusuman, Mergangsan, DI Yogyakarta 55153</p>
                                        </div>
                                    </div>
                                    <div class="footer-number">
                                        <h4><span>+62 </span>274 60 55655</h4>
                    ...
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-4">
                            ...
                            <div class="footer-social f-right">
                                ...
                                <!--<a href="https://goo.gl/maps/iXxHggvga2z1CcN56">--><a href="#"><i class="fas fa-globe"></i></a>
